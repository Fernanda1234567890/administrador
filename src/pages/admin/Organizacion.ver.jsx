...
//     const confirm = window.confirm("¿Seguro que quieres eliminar esta organización?");
//     if (!confirm) return;
...
//   // Función para actualizar (simplemente te permitirá editar en un prompt por ejemplo)
