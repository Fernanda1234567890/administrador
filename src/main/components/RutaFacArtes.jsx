  ...
  return (
    <section className="min-h-screen bg-white flex items-center justify-center py-12 px-6 sm:px-20">
      <div className="text-center max-w-6xl mx-auto w-full">
        <h1 className="text-5xl font-bold text-center mb-8 text-blue-950">FACULTAD DE ARTES</h1>
        ...
        <div className="mt-10 mb-10 flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
          ...
          <div className="text-center md:text-left md:w-1/2">
            <h2 className="text-2xl font-semibold text-blue-900">M. Sc. Lic. Francisco Gonzáles Marce </h2>
        ...
        <div className="flex justify-center gap-6 flex-wrap">
          {[
            { src: 'carArtPlas.jpg', 
              alt: 'Carrera Artes Plasticas', 
              title: 'CARRERA ARTES PLASTICAS', 
              desc: 'Lic. Elias Funes Calderon',
              desc2:'Director de Carrera' 
            },
            { src: 'carArtMus.jpg', 
              alt: 'Carrera Artes Musicales', 
              title: 'CARRERA ARTES MUSICALES', 
              desc: 'M.Sc. Lic. Bernardino Mamani Guerra' ,
              desc2:'Director de Carrera'
            },
            { src: 'carArq.jpg', 
              alt: 'Carrera Arquitectura', 
              title: 'CARRERA ARQUITECTURA',
               desc: 'M. Sc. Arq. Juan Sebastian Jesús Sossa' ,
               desc2:'Director de Carrera'
              },
