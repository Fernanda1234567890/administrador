...
const RutaFacCienSalud = () => {
  ...
  return (
    ...
    <div className="text-center max-w-6xl mx-auto w-full">
      <h1 className="text-5xl font-bold text-center mb-8 text-blue-950">FACULTAD DE CIENCIAS DE LA SALUD</h1>
      ...
      <div className="mt-10 mb-10 flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
        ...
        <div className="text-center md:text-left md:w-1/2">
          <h2 className="text-2xl font-semibold text-blue-900">M. Sc. Lic. Isabel Delgado Janko</h2>
      ...
      {[
        { src: 'carEnf.jpg', 
          alt: 'Carrera Enfermeria', 
          title: 'CARRERA ENFERMERIA', 
          desc: 'M. Sc. Lic. Margarita Rossel',
          desc2:'Directora de Carrera' 
        },
        { src: 'carEnfVill.jpg', 
          alt: 'Carrera Enfermeria Villazon', 
          title: 'CARRERA ENFERMERIA VILLAZON', 
          desc: '.............',
...
export default RutaFacCienSalud;