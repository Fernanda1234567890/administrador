...
import decanomedimg from '../assets/img11.jpg'; 
...
const RutaFacIngGeo = () => {
  ...
  const allItems = [
    {
      src: img1,
      alt: 'Carrera Ing. Geologica',
      title: 'CARRERA INGENIERIA GEOLOGICA',
      desc: 'M. Sc. Ing. Gregorio Arando Taboada ',
      desc2: 'Director de carrera'
    },
    {
      src: img2,
      alt: 'Carrera Ing Medio Ambiente',
      title: 'CARRERA INGENIERIA MEDIO AMBIENTE',
      desc: 'M. Sc. Ing. Jorge Díaz Zelada ',
      ...
      <div className="text-center max-w-6xl mx-auto w-full">
        ...
        <div className="mt-10 mb-10 flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
          <div className="text-center md:text-left md:w-1/2">
            <h2 className="text-2xl font-semibold text-blue-900">M. Sc. Ing. Elias Puch Cabrera</h2>
            <p className="text font-semibold text-blue-900 mt-2">
              Decano de la Facultad de Ingeniería Geológica
            </p>
          </div>
        ...
        {/* Tarjetas de carreras con estilo actualizado */}
          ...
          {allItems.map((item, index) => (
            ...
            >
              ...
              <div className="content relative z-10 h-full flex flex-col justify-center items-center p-4 transform transition duration-300 translate-y-20 opacity-0 hover:translate-y-0 hover:opacity-100">
                <h1 className="text-lg font-semibold text-white mb-2 leading-tight drop-shadow-lg">
                  {item.title}
                </h1>
                <div className="mb-4">
