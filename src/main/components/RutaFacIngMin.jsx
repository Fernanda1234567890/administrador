...
import decanomedimg from '../assets/img12.jpg';
...
const RutaFacIngMin = () => {
  ...
  const allItems = [
    {
      src: img1,
      alt: 'Carrera Ing. Minera',
      title: 'CARRERA INGENIERIA MINERA',
      desc: 'Ing. Franz Freddy Mamani Yucra',
      desc2: 'Director de Carrera',
    },
    {
      src: img2,
      alt: 'Carrera Ing de Procesos',
      title: 'CARRERA ING. DE PROCESOS DE MAT. PRIMA Y MIN.',
      desc: 'Ing. Ricardo Vargas Caba',
      desc2: 'Director de Carrera',
    },
  ];
      ...
      <div className="text-center max-w-6xl mx-auto w-full">
        ...
        <div className="mt-10 mb-10 flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
          <div className="text-center md:text-left md:w-1/2">
            <h2 className="text-2xl font-semibold text-blue-900">M. Sc. Ing. Epifanio Mamani Alizares</h2>
            <p className="text font-semibold text-blue-900 mt-2">Decano de la Facultad Minera</p>
          </div>
        ...
        {/* Tarjetas con estilo actualizado */}
