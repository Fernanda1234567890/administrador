...
import decanomedimg from '../assets/img14.jpg';
  ...
  const items = [
    {
      src: img1,
      alt: 'Carrera Física',
      title: 'CARRERA FISICA',
      desc: 'M. Sc. Lic. Simon Huaquipa Callamuyo',
      desc2: 'Director de Carrera',
    },
    {
      src: img2,
      alt: 'Carrera Matematicas',
      title: 'CARRERA MATEMATICAS',
      desc: 'M. Sc. Lic. Gonzalo Pool García ',
      desc2: 'Director de Carrera',
    },
    {
      src: img3,
      alt: 'Carrera Química',
      title: 'CARRERA QUIMICA',
      desc: 'M. Sc. Lic. Elena García Ayala',
      desc2: 'Directora de Carrera',
    },
    {
      src: img4,
      alt: 'Carrera Ing. Informatica',
      title: 'CARRERA INGENIERIA INFORMATICA',
      desc: 'M. Sc. Lic. Orlando Choque Ayma',
      desc2: 'Director de Carrera',
    },
    {
      src: img5,
      alt: 'Carrera Estadistica',
      title: 'CARRERA ESTADISTICA',
      desc: 'M. Sc. Lic. Nelly Camacho Ocsachoque',
      desc2: 'Directora de Carrera',
    },
  ];
  ...
  return (
    <section className="min-h-screen bg-white flex items-center justify-center py-12 px-6 sm:px-20">
      <div className="text-center max-w-6xl mx-auto w-full">
        <h1 className="text-5xl font-bold text-center mb-8 text-blue-950">FACULTAD DE CIENCIAS PURAS</h1>

        <div className="mt-10 mb-10 flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
          <div className="text-center md:text-left md:w-1/2">
            <h2 className="text-2xl font-semibold text-blue-900">M. Sc. Lic. Oscar Gunnar Barrientos Enriquez</h2>
            <p className="text font-semibold text-blue-900 mt-2">
              Decano de la Facultad de Ciencias Puras
            </p>
          </div>
...
export default RutaFacCienPuras;