  ...
  return (
    <section className="min-h-screen bg-white flex items-center justify-center py-12 px-6 sm:px-20">
      <div className="text-center max-w-6xl mx-auto w-full">
        <h1 className="text-5xl font-bold text-center mb-8 text-blue-950">FACULTAD DE INGENIERIA TECNOLOGICA</h1>
        ...
        <div className="mt-10 mb-10 flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
          ...
          <div className="text-center md:text-left md:w-1/2">
            <h2 className="text-2xl font-semibold text-blue-900">Ing. Juan Carlos Díaz Martinez</h2>
            <p className="text font-semibold text-blue-900 mt-2">
            Decano de la Facultad de Ingeniería Tecnológica
            </p>
          </div>
        ...
        <div className="flex justify-center gap-6 flex-wrap">
          {[
            { src: 'carElectrica.jpg', 
              alt: 'Carrera Electrica', 
              title: 'CARRERA ELECTRICA', 
              desc: 'M. Sc. Ing. Humberto Soto Terceros ',
              desc2:'Director de Carrera' 
            },
            { src: 'carElectronica.jpg', 
              alt: 'Carrera Electronica', 
              title: 'CARRERA ELECTRONICA', 
              desc: 'M.Sc. Ing. Weymar Ramiro Russo Negrón',
              desc2:'Director de Carrera' 
            },
            { src: 'carAutomo.jpg',
               alt: 'Carrera Automotriz', 
               title: 'CARRERA AUTOMOTRIZ', 
               desc: 'DM. Sc. Ing. Mario Saavedra Montero',
               desc2:'Director de Carrera' 
              },
            { src: 'carMeca.jpg', 
              alt: 'Carrera Mecanica', 
              title: 'CARRERA MECÁNICA', 
              desc: 'Ing. Raul Lima Mamani',
              desc2:'Director de Carrera' 
            },
            { src: 'carMecatr.jpg', 
              alt: 'Carrera Mecatronica', 
              title: 'CARRERA MECATRONICA', 
              desc: 'Ing. Vladimir Mamani Llanos',
              desc2:'Director de Carrera' 
            },
