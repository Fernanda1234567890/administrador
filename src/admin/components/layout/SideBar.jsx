...
import FRONTIS from "@admin/assets/FRONTIS.png";
            ...
            <li>
              ...
              {openMenu === "tipo-unidades" && (
                <ul className="pl-6 mt-2 space-y-1">
                  <li>
                    <Link
                      to="/admin/tipo-unidades/registrar"
                      className="block p-2 text-white rounded-lg hover:bg-gray-700 transition-colors duration-200"
                      onClick={() => setIsOpen(false)}
                    >
                      Registrar
            ...
            <li>
              ...
              {openMenu === "organizacion" && (
                <ul className="pl-6 mt-2 space-y-1">
                  <li>
                    <Link
                      to="/admin/organizacion/registrar"
                      className="block p-2 text-white rounded-lg hover:bg-gray-700 transition-colors duration-200"
                      onClick={() => setIsOpen(false)}
                    >
                      Registrar
            ...
            <li>
              ...
              {openMenu === "cargo-regular" && (
                <ul className="pl-6 mt-2 space-y-1">
                  <li>
                    <Link
                      to="/admin/cargo-regular/registrar"
                      className="block p-2 text-white rounded-lg hover:bg-gray-700 transition-colors duration-200"
                      onClick={() => setIsOpen(false)}
                    >
                      Registrar
            ...
            <li>
              ...
              {openMenu === "cargos-intermedios" && (
                <ul className="pl-6 mt-2 space-y-1">
                  <li>
                    <Link
                      to="/admin/cargos-intermedios/registrar"
                      className="block p-2 text-white rounded-lg hover:bg-gray-700 transition-colors duration-200"
                      onClick={() => setIsOpen(false)}
                    >
                      Registrar
                  ...
                  <li>
                    <Link
                      to="/admin/cargos-intermedios/ver"
                      className="block p-2 text-white rounded-lg hover:bg-gray-700 transition-colors duration-200"
                      onClick={() => setIsOpen(false)}
                    >
                      Ver Lista
            ...
            <li>
              ...
              {openMenu === "estudiantes" && (
                <ul className="pl-6 mt-2 space-y-1">
                  <li>
                    <Link
                      to="/admin/estudiantes/registrar"
                      className="block p-2 text-white rounded-lg hover:bg-gray-700 transition-colors duration-200"
                      onClick={() => setIsOpen(false)}
                    >
                      Registrar
          ...
          <div>
            ...
            <li>
              ...
              <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m13 19-6-5-6 5V2a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v17Z"/>
                ...
                <span className="flex-1 text-left">Facultades/Carreras</span>
          ...
          <div>
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 text-left">Asignaciones</span>
              ...
              {openMenu === "asignaciones" && (
                <ul className="pl-6 mt-2 space-y-1">
                  <li>
                    <Link
                      to="/admin/asignaciones-docentes/ver"
                      className="block p-2 text-white rounded-lg hover:bg-gray-700 transition-colors duration-200"
                      onClick={() => setIsOpen(false)}
                    >
                      Docentes
                  ...
                  <li>
                    <Link
                      to="/admin/asignaciones-admin/ver"
                      className="block p-2 text-white rounded-lg hover:bg-gray-700 transition-colors duration-200"
                      onClick={() => setIsOpen(false)}
                    >
                      Administrativos
