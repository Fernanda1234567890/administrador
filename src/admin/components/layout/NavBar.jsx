...
import Logout from "@admin/components/admin/Logout"; 
import { UserAvatar } from "@admin/components/layout/UserAvatar";
          ...
          {isDropdownOpen && (
            <div className="absolute right-0 mt-2 w-60 bg-red-900 rounded-xl shadow-lg z-50 text-white text-sm">
              ...
              <ul className="py-2 space-y-1">
                <li>
                  <Link to="/admin/activities" className="block px-4 py-2 hover:bg-blue-950 rounded transition-colors">
                    Mis Actividades
                  </Link>
                </li>
                <li>
                  <Link to="/admin/settings" className="block px-4 py-2 hover:bg-blue-950 rounded transition-colors">
                    Ajustes
                  </Link>
                </li>
                <li>
                  <Link to="/admin/change-password" className="block px-4 py-2 hover:bg-blue-950 rounded transition-colors">
                    Cambiar contraseña
                  </Link>
                </li>
                <li>
