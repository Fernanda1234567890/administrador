...
import UsuarioService from "@admin/services/Usuario";
import logo from '../../assets/logo-uatf.png'; 
import frontis from '../../assets/FRONTIS.png';
import { login } from "@admin/services/auth"; 
...
const Login = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(15, 0, 58, 0.6), rgba(0,0,0,0.6)), url(${frontis})`,
    ...
    >
      <div className="w-full max-w-xs bg-white/15 backdrop-blur-md p-8 sm:p-10 rounded-2xl shadow-lg text-white">
        ...
        <form onSubmit={handleSubmit} className="space-y-2">
          <div>
            <label htmlFor="email" className="text-sm font-medium mb-1  text-left">Email </label>
          ...
          <div>
            <label htmlFor="password" className="text-sm font-medium mb-1  text-left">Password</label>
            <div className="flex items-center border-b border-white/30 py-2">
              <input
                id="password"
                type="password"
