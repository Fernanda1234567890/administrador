...
return (
  <div className="p-6 sm:p-2 lg:p-12 min-h-screen dark:bg-white">
    <div className="flex justify-between items-center mb-4">
      <h2 className="text-2xl font-bold text-gray-800">Unidades</h2></div> 
        ...
        <div className="mb-4 flex justify-between items-center">
          ...
          <button
            onClick={() => navigate("/admin/unidad/registrar")}
          ...
          <tbody>
            {unidades.map((unidad) => (
              <tr key={unidad.id} className="border-b hover:bg-gray-100">
                ...
                <td className="p-3">
                    {unidad.depende_de ? unidad.depende_de.nombre : "-"}
                  </td>                <td className="p-3">{unidad.id_tipo_unidad}</td>
