...
import administrativosData from "@admin/services/administrativos";
import cargosRegularesData from "@admin/services/cargosRegulares";
import unidadesData from "@admin/services/unidades";
import administrativoCargoRegularUnidadData from "@admin/services/administrativoCargoRegularUnidad";
...
const AdministrativoAsignacion = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.fecha_ingreso) return alert("Seleccione la fecha de ingreso");
   ...
   try {
    await administrativoCargoRegularUnidadData().create({
      ...
      navigate("/admin/asignaciones-admin/ver");
  } catch (error) {
