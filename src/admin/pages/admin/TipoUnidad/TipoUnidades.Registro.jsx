...
import { postData } from "@admin/services/api";
...
const TipoUnidadesRegistro = ({ onRegistrar, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (onClose) onClose();
      navigate("/admin/tipo-unidades/ver");
  ...
  return (
    <div className="max-w-md mx-auto mt-10 bg-white p-6 rounded-lg shadow-lg">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label htmlFor="tipo" className="block text-sm font-medium mb-1 text-left">Tipo de Unidad</label>
          <input
            type="text"
            id="tipo"
            name="tipo"
